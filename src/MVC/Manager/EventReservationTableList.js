...
import EventReservationTable from '../Component/ViewList/TableList/EventReservationTableList'
...
class EventReservationTableList extends Component{
    ...
    render(){
        ...
        }if(this.props.member.typemember === "Event Manager"&&this.props.login.username !== null){
            fillteredContract = this.props.reservationlist.filter(card=>{
        ...
        if(this.props.member.username !== null){
            View = <div className="container-fluid">
                ...
                <tbody>
                {
                    ...
                    return <EventReservationTable
                        ID = {card.ID}
                        Eventname = {card.Eventname}
                        PriceofEvent = {card.PriceofEvent}
                        Status = {card.Status}
                        Username = {card.Username}
                        Eventamount = {card.Eventamount}
                    />
                    })
                }                
                </tbody>
