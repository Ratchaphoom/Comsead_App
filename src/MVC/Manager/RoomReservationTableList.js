...
import RoomReservationTable from '../Component/ViewList/TableList/RoomReservationTable'
...
class RoomReservationTableList extends Component{
    ...
    render(){
        ...
        }if(this.props.member.typemember === "Room Manager"&&this.props.login.username !== null){
            fillteredContract = this.props.reservationlist.filter(card=>{
            ...
            View = <div className="container-fluid">
                ...
                <tbody>
                {
                    ...
                    return <RoomReservationTable
                        ...
                        Roomamount = {card.Roomamount}
                        PriceofRoom = {card.PriceofRoom}
                    />
                    })
                }                
                </tbody>
