    ...
    render(){
        return(
            <div className="container">
             <div class="row">
                <div class="col-12 col-md-8"><h1 className="text-left" style={{fontSize:"60px",width:"fit-content"}}>Villa Wing<br/></h1></div>
                </div>
                <hr style={{height:"2px",backgroundColor : "#2E2E2E"}}/>
                <RoomList namepage="Villa Wing" status="View"></RoomList>
            </div>
        )
    }
